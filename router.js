...
apiRouter.get("/", (req, res) => res.json({ "msg": "Hello, if you see this message that means your backend is up and running successfully. Congrats! Now let's continue learning React!" }))
